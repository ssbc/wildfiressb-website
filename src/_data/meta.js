...
export const siteName = 'WildfireSSB';
export const siteDescription = 'Decentralized Communication for Wildfire Response';
export const siteType = 'Person'; // schema
export const locale = 'en_EN';
export const lang = 'en';
export const skipContent = 'Skip to content';
export const author = {
  name: 'WildfireSSB team', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: '', // i.e. hola@lenesaile.com - email of the author
  website: 'https:/WildfireSSB.scuttlebutt.nz/', // i.e. https.://www.lenesaile.com - the personal site of the author
...
export const creator = {
  name: 'WildfireSSB team', // i.e. Lene Saile - creator's (developer) name.
  email: '',
  website: 'https://WildfireSSB.scuttlebutt.nz',
  social: ''
};
...
export const opengraph_default_alt =
  "WildfireSSB: Decentralized Communication for Wildfire Response"; // alt text for default meta image"
export const blog = {
  // RSS feed
  name: 'WildfireSSB Blog',
  description: 'WildfireSSB',
